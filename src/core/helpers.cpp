                           ...
                           bool generate_mipmap)
{
	...
	auto data_negx = getTextureData(negx, width, height, false);
	...
	glTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X,
	             ...
	             /* the format of the pixel data: which components are available */GL_RGBA,
	             /* the type of each component */GL_UNSIGNED_BYTE,
	             /* the pointer to the actual data on the CPU */reinterpret_cast<GLvoid const*>(data_negx.data()));
